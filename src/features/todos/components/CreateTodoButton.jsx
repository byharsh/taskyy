...
const CreateTodoButton = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`group inline-flex justify-center min-w-[min(100%,12rem)] items-center gap-3 rounded-xl border border-neutral-100/90 bg-white/95 px-8 py-2 text-left shadow-[0_6px_22px_-6px_rgba(0,0,0,0.08),0_1px_4px_rgba(0,0,0,0.04)] ring-1 ring-neutral-200/30 backdrop-blur-sm transition hover:border-neutral-200/80 hover:bg-white hover:shadow-[0_10px_28px_-6px_rgba(0,0,0,0.1)] active:scale-[0.995] ${className}`}
    >
      <span
